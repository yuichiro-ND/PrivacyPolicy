...
Lever ON は、アプリ「チバリヨチェリーカウンター」「TOKIOハカマカウンター」「ハラキリDRIVEカウンター」「ジャグPro」「かいてん！　〜パチンコ回転率計算アプリ〜」「モンキーV〜5枚役カウンター〜」を無料で提供しています。このサービスは、Yuichiro Noda によって無償で提供されており、現状のままで使用することを目的としています。
